...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
   ...
   <!-- Chat AI Agent Card -->
<div class="relative bg-white dark:bg-gray-900 rounded-3xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-yellow-400">
    <div class="absolute inset-0 bg-gradient-to-r from-yellow-400/10 to-orange-400/10 opacity-75 rounded-2xl"></div>
    <div class="relative">
        ...
        <div class="mt-4">
            <a href="{{ route('chat') }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 dark:bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-600 dark:hover:bg-yellow-500 transition-colors duration-200">
                Start Chatting
...
<!-- Speech-to-Text Card -->
<div class="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-yellow-400">
    <div class="absolute inset-0 bg-gradient-to-r from-yellow-400/10 to-orange-400/10 opacity-75 rounded-2xl"></div>
    <div class="relative">
        <div class="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="h-8 w-8 stroke-yellow-600 dark:stroke-yellow-400">
        ...
        <div class="mt-4">
            <a href="{{ route('audio.processor') }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 dark:bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-600 dark:hover:bg-yellow-500 transition-colors duration-200">
                Convert Audio
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-2 h-5 w-5 fill-white">
                    <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                </svg>
...
<div class="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-yellow-400">
    ...
    <div class="relative">
        ...
        <div class="mt-4">
            <a href="{{ route('audio.aws') }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 dark:bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-600 dark:hover:bg-yellow-500 transition-colors duration-200">
                Start Transcription
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-2 h-5 w-5 fill-white">
                    <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                </svg>
...
<div class="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-yellow-400">
    ...
    <div class="relative">
        ...
        <p class="mt-3 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            Analyze images and extract structured data from credit cards or other documents using AI Vision Agent. Upload, process, and get results instantly.
        </p>
        <div class="mt-4">
            <a href="{{ route('vision') }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 dark:bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-600 dark:hover:bg-yellow-500 transition-colors duration-200">
                Start Analysis
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-2 h-5 w-5 fill-white">
                    <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                </svg>
