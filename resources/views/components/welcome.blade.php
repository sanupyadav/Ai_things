...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div class="relative bg-white dark:bg-gray-900 rounded-3xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-indigo-400">
        <div class="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-75 rounded-2xl"></div>
        <div class="relative">
            ...
            <div class="mt-4">
                <a href="{{ route('chat') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:bg-indigo-700 dark:hover:bg-indigo-600">
                    Start Chatting
    ...
    <!-- Speech-to-Text Card -->
    <div class="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md transition-all duration-300 overflow-hidden p-6 hover:shadow-xl hover:border-green-400">
        <div class="absolute inset-0 bg-gradient-to-r from-green-400/10 to-teal-400/10 opacity-75 rounded-2xl"></div>
        <div class="relative">
            <div class="flex items-center gap-3">
